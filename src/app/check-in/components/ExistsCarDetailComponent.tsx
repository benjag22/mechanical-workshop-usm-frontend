...
export default function ExistsCarDetailComponent({ car, onBackAction, onCarDataChange }: ExistsCarDetailComponentProps){
  ...
  useEffect(() => {
    onCarDataChange({
      carId: car.id,
      reason: carDetail.reason,
      gasLevel: carDetail.fuelLevel,
      mileage: carDetail.mileage
    });
  }, [carDetail, car.id, onCarDataChange]);
        ...
        <div className={cn(
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4 text-sm lg:text-base">
            <div>
              ...
              <p className="text-white font-semibold">{car.licensePlate}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white font-semibold">{car.modelYear}</p>
            </div>
            <div>
              <p className="text-gray-400">Tipo</p>
              <p className="text-white font-semibold">{car.modelType}</p>
            </div>
            <div>
